...
public class SharePreferenceUtil {
    ...
    public SharePreferenceUtil(Context context) {
        this(context, ConfigUtils.DEFAULT_PREFERENCE_NAME, Context.MODE_PRIVATE);
    }

    public SharePreferenceUtil(Context context, String preferenceName) {
        this(context, preferenceName, Context.MODE_PRIVATE);
    }

    @SuppressLint("CommitPrefEdits")
    public SharePreferenceUtil(Context context, String preferenceName, int mode) {
    ...
    public void selectKeyAll() {
        ...
        for (String key : map.keySet()) {
            Timber.d("key= " + key + " and value= " + map.get(key));
        }
    }
}